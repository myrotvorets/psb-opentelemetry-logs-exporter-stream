...
TEST_F(StreamExporterTest, InvalidTrace)
{
    ...
    const opentelemetry::trace::SpanContext ctx(true, false);
...
TEST_F(StreamExporterTest, ValidTrace)
{
    ...
    const opentelemetry::trace::TraceId tid(tid_data);
    const opentelemetry::trace::SpanId sid(sid_data);
...
TEST_F(StreamExporterTest, EventdId)
{
    ...
    const opentelemetry::logs::EventId eid(24'081'990, "E-V-E-N-T");
